...
\definecolor{speargreen}{RGB}{26,150,65}
...
\author{%
  ...
  \small USTHB — University of Science and Technology Houari Boumediene\\
  \small \texttt{[email@usthb.dz]}
}
...
otherwise perfectly regular occurrences --- the entire item is
rejected.
...
regularity.
Critically, this \textbf{eliminates the \texttt{maxReg} parameter}
--- the weight \emph{is} the threshold.
...
\begin{itemize}[leftmargin=*]
  \item \textbf{Clinical relevance.}
        SPEAR's top-10 rules have mean clinical weight 0.665 --- 70\%
  ...
  \item \textbf{Speed.}
        SPEAR runs in 0.006\,s --- $37\times$ faster than MWAR-SW
...
Computer Science at USTHB for computational resources.
